...
ofstream out("C:\\Users\\11347\\Desktop\\test.txt");
//定义IP地址
...

{
	...
	out << "FTP:" << v[3] << "  USER:" << ftp[m_ip_message][0] << "  PASS:" << ftp[m_ip_message][1] << "  STA:" << ftp[m_ip_message][2] << endl;
